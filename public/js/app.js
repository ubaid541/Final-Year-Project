...
function initAdmin() {
  ...
  function renderItems(items) {
    ...
    return parseItems.map(function (menuItem) {
      return "\n         <td class=\"text-center\">".concat(menuItem.item.pro_name, "</td>\n         <td class=\"text-center\">").concat(menuItem.item.pro_price, "/Rs</td>\n         <td class=\"text-center\">").concat(menuItem.qty, "-Pcs</td>\n         <td class=\"text-center\">\n         ").concat(menuItem.item.addon != 0 ? menuItem.item.pro_addon.addon_name : 'no addon', " -\n         ").concat(menuItem.item.addon != 0 ? menuItem.item.pro_addon.addon_price : '', "\n         </td>\n         <td class=\"text-center\">\n         ").concat(menuItem.item.attr != 0 ? menuItem.item.pro_attr.attr_name : 'no attribute', " -\n         ").concat(menuItem.item.addon != 0 ? menuItem.item.pro_attr.attr_price : '', "\n         </td>\n         ");
    }).join('');
  }

  function generateMarkup(orders) {
    return orders.map(function (order) {
      return ["\n             <tr>\n             <td class=\"text-center\">".concat(order._id, "</td>\n             <td class=\"text-center\">").concat(order.customerId.username, "</td>\n             <td class=\"text-center\">").concat(order.phone, "</td>\n             <td class=\"text-center\">").concat(order.address, "</td>\n             <td class=\"text-center\">COD</td>\n             <td class=\"text-center\">\n             <form action=\"/admin/order/payment_status\" method=\"post\">\n             <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n             <select name=\"payment_status\" class=\"form-select\" aria-label=\"Default select example\" onchange=\"this.form.submit()\">\n                 <option value=\"paid\" ").concat(order.payment_status === 'paid' ? 'selected' : '', ">Paid</option>\n                 <option value=\"unpaid\" ").concat(order.payment_status === 'unpaid' ? 'selected' : '', ">Unpaid</option>\n             </select>\n             </form>\n             </td>\n             <td class=\"text-center\">\n             <form action=\"/admin/order/status\" method=\"post\">\n             <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n             <select name=\"status\" class=\"form-select\" aria-label=\"Default select example\" onchange=\"this.form.submit()\">\n                 <option selected>Status</option>\n                 <option value=\"order_placed\" ").concat(order.status === 'order_placed' ? 'selected' : '', ">Order Placed</option>\n                 <option value=\"processing\" ").concat(order.status === 'processing' ? 'selected' : '', ">Processing</option>\n                 <option value=\"completed\" ").concat(order.status === 'completed' ? 'selected' : '', ">Completed</option>\n                 <option value=\"cancelled\" ").concat(order.status === 'cancelled' ? 'selected' : '', ">Cancelled</option>\n             </select>\n             </form>\n             </td>\n             <td class=\"text-center\"> ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('YYYY-MM-DD hh:mm A'), "</td>\n             <td class=\"text-center\">").concat(order.totalPrice, "/Rs</td>\n             <td class=\"text-center\">\n               <div class=\"dropdown\">\n                 <button\n                   class=\"btn btn-secondary btn-sm dropdown-toggle\"\n                   type=\"button\"\n                   id=\"dropdownMenuButton1\"\n                   data-bs-toggle=\"dropdown\"\n                   aria-expanded=\"false\"\n                 >\n                   <i class=\"bi bi-gear-fill\"></i>\n                 </button>\n                 <ul\n                   class=\"dropdown-menu shadow-lg rounded mt-1\"\n                   aria-labelledby=\"dropdownMenuButton1\"\n                 >\n                   <li>\n                     <a\n                       class=\"dropdown-item\"\n                       href=\"/admin/delete-order/").concat(order._id, "\"\n                       >Delete</a\n                     >\n                   </li>\n                 </ul>\n               </div>\n             </td>\n           </tr>\n           <tr>\n           <td class=\"text-center fw-bold\">Product details</td>\n           <tr>\n           ").concat(renderItems(order.items), "\n           </tr>\n           </tr>\n            ")];
    }).join('');
  }
}
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    product.qty = parseInt(qty); // let business_id = document.querySelector('#business_id').value
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfatafut_mungwaen"] = self["webpackChunkfatafut_mungwaen"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/style"], () => (__webpack_require__("./resources/css/app.scss")))
